...
pub struct KondoLattice2ChModel {
    ...
    pub hopping_0: AHashMap<(usize, usize), f64>,

    /// hopping terms for channel 1: (i, j) -> t_ij^(1)
    pub hopping_1: AHashMap<(usize, usize), f64>,
    ...
    pub density_density_0: AHashMap<(usize, usize), f64>,

    /// density-density interaction within channel 1: (i, j) -> V_ij^(1)
    pub density_density_1: AHashMap<(usize, usize), f64>,

    /// density-density interaction between channels: (i, j) -> V_ij^(01) for n_{i,0} n_{j,1}
    pub density_density_01: AHashMap<(usize, usize), f64>,
...
impl KondoLattice2ChModel {
    pub fn new(
        spin_list: Vec<f64>,
        hopping_0: AHashMap<(usize, usize), f64>,
        hopping_1: AHashMap<(usize, usize), f64>,
        u_list_0: Vec<f64>,
        u_list_1: Vec<f64>,
        mu_list_0: Vec<f64>,
        mu_list_1: Vec<f64>,
        hz_c_list_0: Vec<f64>,
        hz_c_list_1: Vec<f64>,
        density_density_0: AHashMap<(usize, usize), f64>,
        density_density_1: AHashMap<(usize, usize), f64>,
        density_density_01: AHashMap<(usize, usize), f64>,
        hz_f_list: Vec<f64>,
        d_list: Vec<f64>,
...
mod tests {
    ...
    fn accept_valid_input() {
        ...
        let mut hopping_0 = AHashMap::new();
        hopping_0.insert((0, 1), 1.0);
        let hopping_1 = AHashMap::new();
        ...
        let density_density_0 = AHashMap::new();
        let density_density_1 = AHashMap::new();
        let density_density_01 = AHashMap::new();
